...
data_dir = "../data/"
rosbag_file_gps = os.path.join(data_dir, "udacity-dataset_io_vehicle_2016-10-20-13-46-48_0.bag")
rosbag_file_imgs = os.path.join(data_dir, "udacity-dataset_sensor_camera_center_2016-10-20-13-46-47_0.bag")
