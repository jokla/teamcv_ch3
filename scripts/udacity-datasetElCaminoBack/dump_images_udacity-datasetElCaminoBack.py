...
rosbag_file = os.path.join(data_dir, "udacity-dataset_sensor_camera_center_2016-10-20-15-13-30_0.bag")
...
center_images_dir = get_image_dir("center_udacity-datasetElCaminoBack")
